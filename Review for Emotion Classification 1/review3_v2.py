...
print("학습 데이터 처리")
'''
read_txt_files_with_skip, chunk_data_hp 함수 사용
return 모양 및 입력 변수 잘 맞춰 수정
tot="train" 잊지 말기
'''
x = np.array(x_train)
y = np.array(y_train)
'''
GMM_model, CNN_Model 함수 사용
학습용
'''
...
'''
GMM_model 사용
model은 global로 이미 학습할 때 받았기 때문에 또 선언하진 않으나
실제로 활용할 땐 model도 따로 받아와야 해요!
'''
