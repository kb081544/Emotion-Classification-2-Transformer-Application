...
model_path = r"/HeartGPT-main_example_dataset/HeartGPT-main/Model_files/PPGPT_pretrained_64_8_8_500_1000000_500000_limit_amplitude.pth"
...
def main():
    # Load data
    data = np.loadtxt(
        r"/HeartGPT-main_example_dataset/HeartGPT-main/filtered_processed_blocksize_500_strides_500_ppg_data_limit_amplitude.txt", delimiter=",")
