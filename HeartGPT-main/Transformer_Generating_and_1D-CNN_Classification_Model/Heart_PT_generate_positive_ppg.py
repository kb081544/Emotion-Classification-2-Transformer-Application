'''
high_peak_positive_chunks.csv 파일을 읽어서 각 행을 컨텍스트로 사용하여
...
input_csv_path = "high_peak_positive_no_threshold.csv"  # 증강할 원본 데이터 파일
output_dir = f"augmented_ppg_data_positive_no_threshold"  # 생성된 데이터를 저장할 디렉토리
...
augmented_df.to_csv(os.path.join(output_dir, "all_augmented_data_no_threshold.csv"), index=False, header=False)
